    ...
    if sys.platform == 'win32':
        for req in REQ_WIN:
            try:
                ...
                req_updated = True
    torch_command = os.environ.get('TORCH_COMMAND', "pip install torch==2.2.2 torchvision==0.17.2 --index-url https://download.pytorch.org/whl/cu121 --disable-pip-version-check")
